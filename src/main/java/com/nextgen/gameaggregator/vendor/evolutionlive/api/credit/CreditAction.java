package com.nextgen.gameaggregator.vendor.evolutionlive.api.credit;
...
public class CreditAction {
    ...
    public ResponseVo CreditAction(HttpServletRequest request) {
        ...
        try {
            ...
            DebitCreditCancelDto creditDto = HttpService.convertJsonToDto(body, DebitCreditCancelDto.class);
