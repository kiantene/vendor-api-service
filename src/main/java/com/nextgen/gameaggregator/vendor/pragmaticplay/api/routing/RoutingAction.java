package com.nextgen.gameaggregator.vendor.pragmaticplay.api.routing;
...
public class RoutingAction {
    ...
    private final Map<String, Class<?>> v1Controllers = Map.of(
            "adjustment", com.nextgen.gameaggregator.vendor.pragmaticplay.api.adjustment.AdjustmentAction.class,
    ...
    private final Map<String, Class<?>> v2Controllers = Map.of(
            "adjustment", com.nextgen.gameaggregator.vendor.pragmaticplayv2.api.adjustment.AdjustmentAction.class,
    ...
    @Value("${pp-version:v1}") // Default to v1 if not set
