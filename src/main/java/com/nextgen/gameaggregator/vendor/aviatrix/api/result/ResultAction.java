...
import com.nextgen.gameaggregator.vendor.aviatrix.constant.Operations;
...
public class ResultAction {
    ...
    @PostMapping(EndPoints.WIN)
    public ResponseEntity<ResponseVo> result(HttpServletRequest request) {
        ...
        try {
            ...
            BigDecimal balance;
            ResultDto dto = HttpService.convertJsonToDto(body, ResultDto.class); //transfer to dto
            ...
            //change action depends on operation
            switch (dto.getOperation()) {
                case Operations.SETTLE -> { //settle bet
                    ResultType resultType = VendorService.calculateResultType(dto.getWinAmount(), dto.getBetStatus());
                    balance = walletService.processBetResult(traceId, gameSession, dto, resultType, vendorService, httpRequestLog);
                }
                case Operations.REFUND ->  //rollback
            ...
            httpService.logError(httpRequestLog, betResultIdempotentViolationException);
                 ...
                 com.nextgen.gameaggregator.exception.InvalidFormatException |
            ...
            responseVo.setHttpStatus(HttpStatus.BAD_REQUEST);
            httpService.logError(httpRequestLog, invalidTransactionException);
            ...
            responseVo.setMessage(ResponseCodes.BET_NOT_FOUND);
            responseVo.setHttpStatus(HttpStatus.NOT_FOUND);
    ...
    private void doValidation(ResultDto dto) throws InvalidRequestException {
        //basic validation
        ValidationUtils.validateRequest(dto);
    }

    private void doVerification(ResultDto dto, GameSession gameSession) throws InvalidVendorLineException, CredentialNotFoundException, GameNotSupportedException, CurrencyNotSupportedException, InvalidPlayerException {
        //check cid
