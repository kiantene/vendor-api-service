...
public class GameUrlService implements GameUrl {
    ...
    public GameUrlVo call(MultiValueMap<String, String> formData, Map<String, String> credentials,
            ...
            // Set request body
            String requestBody = "{\"user\":{\"partnerSiteId\":\"" + credentials.get(Credentials.CLIENT_ID) + "\",\"userId\":\""
            ...
            ResponseEntity<String> apiResponse = new RestTemplate().exchange(apiUrl, HttpMethod.POST, httpEntity, String.class);
