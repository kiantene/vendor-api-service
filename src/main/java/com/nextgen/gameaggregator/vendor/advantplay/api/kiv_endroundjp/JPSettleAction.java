...
public class JPSettleAction {
    ...
    public ResponseVo jpSettleAction(HttpServletRequest request) {
        ...
        try {
            ...
            this.doVerification(jpSettleDto, gameSession, apHash, body);
    ...
    private void doVerification(JPSettleDto dto, GameSession gameSession, String apHash, String bodyString)
            throws
