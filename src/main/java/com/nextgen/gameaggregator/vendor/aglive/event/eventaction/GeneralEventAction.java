package com.nextgen.gameaggregator.vendor.aglive.event.eventaction;
...
import com.nextgen.gameaggregator.vendor.aglive.event.constant.EndPoints;
import com.nextgen.gameaggregator.vendor.aglive.event.eventdto.CommonEventDto;
import com.nextgen.gameaggregator.vendor.aglive.event.eventrollback.EventRollBackService;
import com.nextgen.gameaggregator.vendor.aglive.event.eventwithdraw.EventWithDrawService;
...
public class GeneralEventAction {
    ...
    private CommonVo actionHandling(CommonEventDto commonEventDto, String traceId, HttpRequestLog httpRequestLog) throws
        ...
        return switch (commonEventDto.getEventDto().getTransactionType()) {
