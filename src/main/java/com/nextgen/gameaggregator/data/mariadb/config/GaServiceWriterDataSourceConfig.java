...
public class GaServiceWriterDataSourceConfig {
    ...
    @Bean(name = "entityManagerFactoryGaServiceWriterDb")
    @Primary
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryGaServiceWriterDb(EntityManagerFactoryBuilder builder) {
    ...
    @Bean(name = "transactionManagerGaServiceWriterDb")
    @Primary
    PlatformTransactionManager transactionManagerGaServiceWriterDb(EntityManagerFactoryBuilder builder) {
        return new JpaTransactionManager(entityManagerFactoryGaServiceWriterDb(builder).getObject());
    }
