...
public class SportUpdateBetAction {
    ...
    @PostMapping(path = EndPoints.SPORT_UPDATE_BET)
    public ResponseResultVo<Object> walletSportResettle(HttpServletRequest request) {
        ...
        if (requestService.isTestEnvironment()) {
            try {
                ...
                SportUpdateBetDto dto = HttpService.convertJsonToDto(httpRequestLog.getRequestBody(), SportUpdateBetDto.class);
