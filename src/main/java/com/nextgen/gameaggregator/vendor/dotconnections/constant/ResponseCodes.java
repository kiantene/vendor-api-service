...
public class ResponseCodes {
    ...
    public static final Integer UNKNOWN = 1002;
    public static final Integer SIGN_ERROR = 5000;
    public static final Integer REQUEST_PARAM_ERROR = 5001;
    public static final Integer CURRENCY_NOT_SUPPORT = 5002;
    public static final Integer BALANCE_INSUFFICIENT = 5003;
    public static final Integer BRAND_NOT_EXIST = 5005;
    public static final Integer COUNTRY_CODE_ERROR = 5008;
    public static final Integer PLAYER_NOT_EXIST = 5009;
    public static final Integer PLAYER_BLOCK = 5010;
    public static final Integer GAME_ID_NOT_EXIST = 5012;
    public static final Integer NOT_LOGGED_IN = 5013;
    public static final Integer INVALID_TIME_FORMAT = 5014;
    public static final Integer INVALID_PROVIDER = 5015;
    public static final Integer INVALID_AMOUNT = 5016;
    public static final Integer API_INSUFFICIENT_PERMISSION = 5017;
    public static final Integer INVALID_BRAND_UID = 5018;
    public static final Integer RATE_LIMIT_EXCEEDED = 5040;
    public static final Integer REQUEST_DATE_RANGE_LIMIT_EXCEEDED = 5041;
    public static final Integer BET_RECORD_NOT_EXIST = 5042;
    public static final Integer BET_RECORD_DUPLICATE = 5043;
    public static final Integer FREE_SPIN_ID_NOT_EXIST = 5070;
    public static final Integer INVALID_ROUND_COUNT = 5071;
    public static final Integer FREE_SPIN_CANCELLED = 5072;
    public static final Integer FREE_SPIN_LOCKED = 5073;
    public static final Integer FREE_SPIN_NOT_SUPPORT = 5074;
    public static final Integer FREE_SPIN_SET_UP_ERROR = 5075;
