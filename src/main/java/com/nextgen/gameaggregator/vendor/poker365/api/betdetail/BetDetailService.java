...
public class BetDetailService implements BetDetailUrl {
    ...
    @Override
    public BetDetailVo call(MultiValueMap<String, String> formData, Map<String, String> credentials, IBetDetailUrlInfo iBetDetailUrlInfo, VendorLanguageCode vendorLanguageCode)
