package com.nextgen.gameaggregator.vendor.alizegames.api.betdetail;
...
public class BetDetailService implements BetDetailUrl {
    ...
    public BetDetailUrlVo call(MultiValueMap<String, String> formData, Map<String, String> credentials,
        ...
        return new com.nextgen.gameaggregator.vendor.alizegames.api.betdetail.BetDetailUrlVo();
    }
}
