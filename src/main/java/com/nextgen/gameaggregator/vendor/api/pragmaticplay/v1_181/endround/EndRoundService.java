...
public class EndRoundService {
    ...
    public void validateRequest(EndRoundDto dto, Class<EndRoundDto> clazz) throws InvalidRequestException {
        Map<String, String> validationMap = new HashMap<String, String>();

        Validator validator = Validation.buildDefaultValidatorFactory().getValidator();

        Set<ConstraintViolation<EndRoundDto>> violations = validator.validate(dto);
        for (ConstraintViolation<EndRoundDto> violation : violations) {
    ...
    public SeamlessBetHistoryRequest getSeamlessBetRequestId(EndRoundDto dto){
    ...
    public void createRawBetHistorySeamlessOthersCouchBase(String rawRequest, String getVendorCurrencyCode)
    {
        ...
        BetHistorySeamlessOthersRequest dataSet = new BetHistorySeamlessOthersRequest(betHistoryId+"_4", "endRound",
    ...
    public void createRecordToKafkaBetHistoryTopic(String betHistoryId, VendorPlayerAuthentication vpa, String rawRequest)
    {
        ...
        BetHistorySeamlessRequest dataSet = new BetHistorySeamlessRequest(betHistoryId+"_4", "endRound", "SLOT",
    ...
    public BigDecimal getBetRequestBalanceFromGRPC(EndRoundDto dto, String traceId, VendorPlayerAuthentication vpa,
