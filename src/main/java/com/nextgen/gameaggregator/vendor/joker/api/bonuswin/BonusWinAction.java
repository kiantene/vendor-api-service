...
//        commonVo.setBalance(1000.00);
        ...
        try{
            ...
            RawGameSession rawGameSession = gameSessionService.getGameSessionByVendorPlayerUsernameAndVendorGameCode(bonusWinDto.getUsername().toLowerCase(), bonusWinDto.getGamecode());

            // Verify remaining parameters (Verify against database values)
            this.doVerification(httpRequestLog, bonusWinDto, rawGameSession);

            //Process full bet data
            SettledBetEvent settledBetEvent = walletService.processUnsettleResultSettle(traceId, rawGameSession, bonusWinDto, body);
    ...
    private void doVerification(HttpRequestLog request, BonusWinDto bonusWinDto, RawGameSession rawGameSession) throws NoAvailableLineException, CredentialNotFoundException, DisabledVendorLineException, DisabledAgentPlayerException, DisabledGameException, InvalidPlayerException, InvalidSignatureException {
        ...
        validationService.validateIllegibleBet(rawGameSession, bonusWinDto.getUsername());
    }
