...
public class EndRoundAction extends AbstractAction {
    ...
    @PostMapping(path = Constant.ACTION_END_ROUND)
    public EndRoundActionVo endRound(EndRoundActionDto dto, WebRequestWrapper request) {
        ...
        dto = this.queryStringToDto(request.getBody(), EndRoundActionDto.class);
        EndRoundActionVo thisVo = new EndRoundActionVo();
        thisVo.setTraceId(traceId);

        //* DTO Validation
        Map<String, String> dtoValidationResult = this.doValidation(dto, EndRoundActionDto.class);
        ...
        this.createSeamlessResultLogRecord(VENDOR_CODE+"_endRound_"+aggregatorRequestStartMs+playerToken, aggregatorRequestStartMs,
                request.getBody());
        //endregion
        ...
        if (thisVo.getError() == ConstantErrorMessage.CODE_SUCCESS) {
            ...
            if (vendorPlayerAuthentication != null) {
                ...
                if (vendorAdaptor.getVendor(vendorPlayerAuthentication.getVendorId(), vendorPlayerAuthentication.getWalletType(),
                    ...
                    betResultOutput = vendorAdaptor.seamlessVendor.endRound(formattedOutput);
                    ...
                    if((int)betResultOutput.get("error") == 0){
                        try{
                            ...
                            System.out.println("endRoundAction BEFORE GRPC traceId ::::::" + traceId);
                            ...
                            System.out.println("endRoundAction AFTER GRPC traceId ::::::" + traceId);
                            System.out.println("endRoundAction serviceVo ::::::" + serviceVo);
                            //check grpc status
                            ...
                            logger.error("endRoundAction grpc error : " + e);
                        }
                    } else {
        ...
        System.out.println("endRoundAction traceId ::::::" + traceId);
        System.out.println("endRoundAction thisVo ::::::" + thisVo);
        ...
        if (thisVo.getError() != 0){
            ...
            this.createSeamlessResultLogRecord(VENDOR_CODE+"_endRoundErr_"+aggregatorRequestStartMsErr+playerTokenErr, aggregatorRequestStartMsErr,
