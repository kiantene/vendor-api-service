package com.nextgen.gameaggregator.vendor.aasexyv2.api.voidbet;
...
public class VoidBetService {
    ...
    private void doVerification(VoidBetTransactionsDto voidBetTransactionsDto, GameSession gameSession) throws
        ...
        ValidationUtils.isEquals(gameSession.getVendorGameCode(), voidBetTransactionsDto.getGameCode() + "_" + voidBetTransactionsDto.getGameInfo().getTableId(), GameNotSupportedException::new);
    ...
    private BigDecimal processData(VoidBetTransactionsDto voidBetTransactionsDto, HttpServletRequest request) {
        ...
        try {
            ...
            gameSession = vendorService.verifyAndRegenerateNewVendorGameCodeForGameSession(voidBetTransactionsDto.getGameCode()+"_"+voidBetTransactionsDto.getGameInfo().getTableId(), gameSession);
