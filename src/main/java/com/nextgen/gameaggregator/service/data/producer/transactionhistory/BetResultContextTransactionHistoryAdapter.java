...
public final class BetResultContextTransactionHistoryAdapter implements TransactionHistoryContext {

    private final BetResultContext ctx;

    public BetResultContextTransactionHistoryAdapter(BetResultContext ctx) {
        this.ctx = ctx;
    }
