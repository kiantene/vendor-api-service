package com.nextgen.gameaggregator.vendor.evolutionlive.api.debit;
...
public class DebitAction {
    ...
    public ResponseVo DebitAction(HttpServletRequest request) {
        ...
        try {
            ...
            DebitCreditCancelDto debitDto = HttpService.convertJsonToDto(body, DebitCreditCancelDto.class);
