package com.nextgen.gameaggregator.vendor.evoplay.api.v2.betdetail;
...
import com.nextgen.gameaggregator.vendor.evoplay.api.betdetail.BetDetailUrlVo;
...
public class BetDetailService implements BetDetailUrl {
    ...
    @Override
    public com.nextgen.gameaggregator.vendor.evoplay.api.betdetail.BetDetailUrlVo call(MultiValueMap<String, String> formData, Map<String, String> credentials, IBetDetailUrlInfo iBetDetailUrlInfo, VendorLanguageCode vendorLanguageCode)
