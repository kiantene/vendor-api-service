...
public class BetDetailService implements BetDetailUrl {
    ...
    @Override
    public DGBetDetailUrlVo call(MultiValueMap<String, String> formData, Map<String, String> credentials, IBetDetailUrlInfo iBetDetailUrlInfo, VendorLanguageCode vendorLanguageCode)
            throws InvalidVendorResponseException, InvalidVendorLineException {
        return new DGBetDetailUrlVo();
    }
}
