...
public class JackpotAction {
    ...
    @Autowired
    public JackpotAction(HttpService httpService,
    ...
    public ResponseVo jackpot(HttpServletRequest request) {
        ...
        try {
            ...
            dto = HttpService.convertJsonToDto(body, JackpotDto.class);
    ...
    private void doVerification(JackpotDto dto, GameSession gameSession)
            throws
        ...
        ValidationUtils.isEquals(operatorId, dto.getOperatorId(), InvalidRequestException::new);

        // Generate encryptString
        String secretKey = vendorLineService.getCredentialValueByName(gameSession.getVendorLineId(), Credentials.SECRET_KEY);
        String encryptString = "Jackpot" + dto.getTranId() + dto.getRequestDateTime() + dto.getOperatorId() + secretKey + dto.getPlayerId();
