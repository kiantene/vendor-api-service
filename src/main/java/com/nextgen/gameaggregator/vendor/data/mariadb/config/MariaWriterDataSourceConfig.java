...
@EnableJpaRepositories(
        ...
        basePackages = {"com.nextgen.gameaggregator.vendor.data.mariadb.writer.manager"}//设置持久层所在位置
)
public class MariaWriterDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryMariaWriter(EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages("com.nextgen.gameaggregator.vendor.data.mariadb.writer.entity")
