...
@Component
public class BetResultResponseMapper implements BetResultVendorResponseMapper<ResponseVo> {
    @Override
    public ResponseVo toVendor(BetResultContext context, PlayerBalanceData balanceData) {
