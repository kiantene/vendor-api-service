package com.nextgen.gameaggregator.vendor.aglive.service;
...
public class VendorService extends BaseVendorService {
    ...
    public ResultType roulettleResultType(BigDecimal winAmount) {
    ...
    public ResultType checkResultType(BigDecimal winAmount, String finish) {
        ResultType resultType;
    ...
    public ResultType checkGameType(String gameType, BigDecimal winAmount, String finish) {
        ResultType resultType;

        if ("ROU".equals(gameType)) {
            resultType = this.roulettleResultType(winAmount);
        } else {
            resultType = this.checkResultType(winAmount, finish);
        }
