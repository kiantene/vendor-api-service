...
import com.nextgen.gameaggregator.operator.wallet.betcredit.WalletBetCreditDto;
...
public class BetCreditAction {
    ...
    @PostMapping(path = EndPoints.WALLET_BET_CREDIT)
    public ResponseResultVo<Object> walletBetCredit(HttpServletRequest request) {
        ...
        if (requestService.isTestEnvironment()) {
            try {
                ...
                WalletBetCreditDto dto = HttpService.convertJsonToDto(httpRequestLog.getRequestBody(), WalletBetCreditDto.class);
