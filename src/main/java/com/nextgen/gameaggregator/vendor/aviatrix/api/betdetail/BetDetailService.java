...
import com.nextgen.gameaggregator.vendor.gpkasia.api.betdetail.BetDetailUrlVo;
...
public class BetDetailService implements BetDetailUrl {
    ...
    @Override
    public com.nextgen.gameaggregator.vendor.gpkasia.api.betdetail.BetDetailUrlVo call(MultiValueMap<String, String> formData, Map<String, String> credentials, IBetDetailUrlInfo iBetDetailUrlInfo, VendorLanguageCode vendorLanguageCode)
