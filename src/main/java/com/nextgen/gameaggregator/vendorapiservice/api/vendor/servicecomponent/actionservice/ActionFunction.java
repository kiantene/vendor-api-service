package com.nextgen.gameaggregator.vendorapiservice.api.vendor.servicecomponent.actionservice;

import com.nextgen.gameaggregator.vendorapiservice.data.couchbase.config.entity.SeamlessActionLogRepository;
import com.nextgen.gameaggregator.vendorapiservice.data.couchbase.config.entity.SeamlessActionLogRequest;
...
import com.nextgen.gameaggregator.vendorapiservice.data.mariadb.reader.manager.AgentCredentialReaderManager;
import com.nextgen.gameaggregator.vendorapiservice.data.mariadb.reader.manager.VendorReaderManager;
