...
public class TransactionsListDto {
    ...
    @NotNull(message = "min 2000 and max 20000 numeric number only")
    @Positive(message = "min 2000 and max 20000 numeric number only")
    @Range(min = 1, max = 20000, message = "min 2000 and max 20000 numeric number only")
