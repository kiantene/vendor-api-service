...
public class RefundService {
    ...
    public ResponseVo refund(CallbackDto callbackDto, GameSession gameSession, String traceId)
            ...
            CredentialNotFoundException, InvalidAgentApiCredentialException, RecordNotFoundException, BetRefundIdempotentViolationException, InvalidOperatorResponseException, BetNotFoundException, CouchbaseDataIntegrityException, BetResultIdempotentViolationException, TransactionStillProcessingException, VendorCurrencyNotSupportException {
