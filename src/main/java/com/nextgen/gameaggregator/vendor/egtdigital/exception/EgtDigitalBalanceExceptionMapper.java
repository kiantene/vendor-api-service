...
@Component(EndPoints.CLASS_NAME + "balance")
public class EgtDigitalBalanceExceptionMapper implements VendorExceptionMapper {
    @Override
    public String getVendorClassName() {
        return EndPoints.CLASS_NAME + "balance";
    }
    ...
    public VendorErrorResponse onInvalidRequestError(InvalidRequestException ex) {
        return new VendorErrorResponse(HttpStatus.OK, errorResponse(ResponseCodes.ERR_INVALID_ACCOUNT));
    }
