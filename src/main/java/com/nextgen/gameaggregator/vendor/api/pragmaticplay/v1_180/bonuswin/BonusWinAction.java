...
public class BonusWinAction extends AbstractAction {
    ...
    public BonusWinActionVo bonusWin(BonusWinActionDto dto, WebRequestWrapper request) {
        ...
        dto = this.queryStringToDto(request.getBody(), BonusWinActionDto.class);
        BonusWinActionVo thisVo = new BonusWinActionVo();
        thisVo.setTraceId(traceId);

        //* DTO Validation
        Map<String, String> dtoValidationResult = this.doValidation(dto, BonusWinActionDto.class);
        ...
        if (thisVo.getError() == ConstantErrorMessage.CODE_SUCCESS) {
            ...
            if (vendorPlayerAuthentication != null) {
                ...
                if (vendorAdaptor.getVendor(vendorPlayerAuthentication.getVendorId(), vendorPlayerAuthentication.getWalletType(),
                    ...
                    betResultOutput = vendorAdaptor.seamlessVendor.bonusWin(formattedOutput);
                    ...
                    if((int)betResultOutput.get("error") == 0){
                        try{
                            ...
                            logger.error("bonusWin grpc error : " + e);
                        }
                    } else {
