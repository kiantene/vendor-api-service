package com.nextgen.gameaggregator.vendor.live22.api.bet;
...
public class BetAction {
    ...
    public ResponseVo bet(HttpServletRequest request) {
        ...
        try {
            ...
            vo.setOldBalance((betEvent.getLastBalance().add(dto.getBetAmount())).setScale(4, RoundingMode.DOWN));
            vo.setNewBalance(betEvent.getLastBalance().setScale(4, RoundingMode.DOWN));
    ...
    private void doVerification(BetDto dto, GameSession gameSession)
        ...
        String encryptString = "Bet" + dto.getBetId() + dto.getRequestDateTime() + dto.getOperatorId() + secretKey + dto.getPlayerId();
