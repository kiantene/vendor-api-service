...
public class CreditAction {
    ...
    private void doVerification(TransactionsDto transactionsDto, RawGameSession rawGameSession, String clientId, String clientSecret)
            throws
            ...
            InvalidCurrencyException, CurrencyNotSupportedException, GameNotSupportedException {

        //1. validate vendor username, agent vendor line, player status, and game status
        validationService.validateIllegibleBet(rawGameSession, transactionsDto.getUserid());
        ...
        ValidationUtils.isEquals(transactionsDto.getCur(), rawGameSession.getVendorCurrencyCode(), CurrencyNotSupportedException::new);
    ...
    private TransactionsVo processData(TransactionsDto transactionsDto, String clientId, String clientSecret, String traceId) {
        ...
        try {
            ...
            RawGameSession rawGameSession = gameSessionService.getGameSessionByVendorPlayerUsernameAndVendorGameCode(transactionsDto.getUserid(), transactionsDto.getGamecode());

            // 3. Verify Credential and Currency
            this.doVerification(transactionsDto, rawGameSession, clientId, clientSecret);
