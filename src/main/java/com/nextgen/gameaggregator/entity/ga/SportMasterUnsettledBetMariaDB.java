...
@Entity
@Table(name = "sports_master_unsettled_bet")
@Data
@NoArgsConstructor
public class SportMasterUnsettledBetMariaDB {
    @Id
    @JsonProperty("id")
    private String id;
    ...
    public SportMasterUnsettledBetMariaDB(SportUnsettledBet sportUnsettledBet) {
        ModelMapper modelMapper = new ModelMapper();
        modelMapper.getConfiguration().setMatchingStrategy(MatchingStrategies.STRICT);
        modelMapper.map(sportUnsettledBet, this);

        this.setId(sportUnsettledBet.getBetId());
        Optional.ofNullable(sportUnsettledBet.getNewBetAmount()).ifPresent(this::setBetAmount);
    }
}
