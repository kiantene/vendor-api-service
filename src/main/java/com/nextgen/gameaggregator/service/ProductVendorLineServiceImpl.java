...
public class ProductVendorLineServiceImpl implements ProductVendorLineService {
    ...
    public ProductVendorLine getHighestPriorityLine(Integer productId, Integer gameCategoryId, Integer currencyId) throws ProductVendorLineNotFoundException {
        ...
        if (listOfLines.isEmpty()) {
            throw new ProductVendorLineNotFoundException();
        }
