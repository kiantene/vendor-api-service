package com.nextgen.gameaggregator.vendor.evolutionlive.api.cancel;
...
public class CancelAction {
    ...
    public ResponseVo CancelAction(HttpServletRequest request) {
        ...
        try {
            ...
            DebitCreditCancelDto cancelDto = HttpService.convertJsonToDto(body, DebitCreditCancelDto.class);
...
//            GameSession gameSession = gameSessionService.verifyToken(balanceDto.getUserId());
...
//            BigDecimal balance = walletService.getBalance(traceId, gameSession);
            ...
            responseVo.setBalance(BigDecimal.valueOf(111));
