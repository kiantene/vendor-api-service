...
public class CancelTipsService {
    ...
    public CancelTipsVo cancelTips(HttpRequestLog httpRequestLog, HttpServletRequest request, String traceId) {
        ...
        try {
            ...
            CancelTipsTransactionsDto txn = dto.getMessage().getTxns().get(0);
            try {
                ...
                gameSessionService.updateByVendorGameCode(gameSession, txn.getGameCode()+"_"+txn.getTipInfo().getTableId());
    ...
    private void doVerification(CancelTipsTransactionsDto cancelTipsTransactionsDto, GameSession gameSession) throws
        ...
        ValidationUtils.isEquals(gameSession.getVendorGameCode(), String.valueOf(cancelTipsTransactionsDto.getGameCode()+"_"+cancelTipsTransactionsDto.getTipInfo().getTableId()), GameNotSupportedException::new);
