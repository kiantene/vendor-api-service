...
public enum ResponseCode {
    ...
    INVALID_ARGUMENTS           (300, "Invalid arguments: {argument name or reason}"),
    MISSING_TOKEN               (400, "Missing token"),
    INCORRECT_FORMAT            (500, "Incorrect format. {further detail if any}"),
    ...
    SYSTEM_ERROR                (900, "System Error. {further detail if any}"),
