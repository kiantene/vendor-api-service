...
public class CancelWagerAction {
    ...
    public ResponseVo balance(HttpServletRequest request) {
        ...
        try {
             ...
             */
            if (Objects.equals(dto.getWagerType(), WagerTypes.CANCEL_END_WAGER)) {
            ...
            if (Objects.equals(betResultIdempotentViolationException.getStatus(), BetStatus.REFUNDED.code)) {
