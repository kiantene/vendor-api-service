    ...
    private BigDecimal processData(ResettleTransactionsDto resettleTransactionsDto, HttpServletRequest request) {
        ...
        try {
            ...
            try {
                ...
                gameSession = vendorService.verifyAndRegenerateNewVendorGameCodeForGameSession(resettleTransactionsDto.getGameCode()+"_"+resettleTransactionsDto.getGameInfo().getTableId(), gameSession);
            }catch (AuthenticationException e){
                gameSession = gameSessionService.generateNewSessionToken(resettleTransactionsDto.getUserId());
                gameSessionService.updateByVendorGameCode(gameSession, resettleTransactionsDto.getGameCode()+"_"+resettleTransactionsDto.getGameInfo().getTableId());
