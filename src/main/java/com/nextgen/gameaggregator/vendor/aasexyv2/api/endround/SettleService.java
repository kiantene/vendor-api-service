    ...
    private BigDecimal processData(SettleTransactionsDto settleTransactionsDto, HttpServletRequest request){
        ...
        try {
            ...
            try {
                ...
                gameSession = vendorService.verifyAndRegenerateNewVendorGameCodeForGameSession(settleTransactionsDto.getGameCode()+"_"+settleTransactionsDto.getGameInfo().getTableId(), gameSession);
            } catch (AuthenticationException e) {
                gameSession = gameSessionService.generateNewSessionToken(settleTransactionsDto.getUserId());
                gameSessionService.updateByVendorGameCode(gameSession, settleTransactionsDto.getGameCode()+"_"+settleTransactionsDto.getGameInfo().getTableId());
